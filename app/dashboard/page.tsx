              ...
              <div className="relative z-10 max-w-2xl">
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-white text-white dark:text-white hover:bg-white/10 dark:hover:bg-white/10 dark:border-white border-gray-300 text-foreground dark:text-white"
                  >
                    Request Help
                  </Button>
                </div>
