...
import { Home, BookOpen, MessageSquare, User, LogOut, Plus, Moon, Sun, Settings } from "lucide-react"
          ...
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <a href="/admin" className="flex items-center gap-2 text-red-600 dark:text-red-400">
